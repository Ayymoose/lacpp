...
void Bomb::render(SDL_Renderer* pRenderer)
{
    ...
    case BOMB_SPRITE_EXPLOSION:
        ...
        DASSERT(SDL_RenderCopyEx(pRenderer, m_texture, &srcRect, &dstRect, m_orientation, nullptr, SDL_FLIP_NONE) == 0, SDL_GetError());
        dstRect.x += 16;
        DASSERT(SDL_RenderCopyEx(pRenderer, m_texture, &srcRect, &dstRect, m_orientation, nullptr, SDL_FLIP_HORIZONTAL) == 0, SDL_GetError());
        dstRect.y += 16;
        DASSERT(SDL_RenderCopyEx(pRenderer, m_texture, &srcRect, &dstRect, 270, nullptr, SDL_FLIP_VERTICAL) == 0, SDL_GetError());
        dstRect.x -= 16;
        DASSERT(SDL_RenderCopyEx(pRenderer, m_texture, &srcRect, &dstRect, m_orientation, nullptr, SDL_FLIP_VERTICAL) == 0, SDL_GetError());
    ...
    // Bounding Box rect
    // DASSERT(SDL_RenderDrawRect(pRenderer, &boundingRect) == 0, SDL_GetError());
