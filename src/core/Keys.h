...
enum class Key : int
{
    ...
    // Number row (prefixed NUM_ — digits are not valid identifiers)
    NUM_1 = 30, NUM_2 = 31, NUM_3 = 32, NUM_4 = 33, NUM_5 = 34,
    NUM_6 = 35, NUM_7 = 36, NUM_8 = 37, NUM_9 = 38, NUM_0 = 39,
    ...
    KP_TAB              = 186,
    KP_BACKSPACE        = 187,
    KP_A                = 188, KP_B = 189, KP_C = 190,
    KP_D                = 191, KP_E = 192, KP_F = 193,
    KP_XOR              = 194,
    KP_POWER            = 195,
    KP_PERCENT          = 196,
    KP_LESS             = 197,
...
// Gameboy-style button aliases
constexpr inline Key BUTTON_A = Key::Z;
constexpr inline Key BUTTON_B = Key::X;
constexpr inline Key BUTTON_UP = Key::UP;
constexpr inline Key BUTTON_DOWN = Key::DOWN;
constexpr inline Key BUTTON_LEFT = Key::LEFT;
constexpr inline Key BUTTON_RIGHT = Key::RIGHT;
constexpr inline Key BUTTON_START = Key::RETURN;
constexpr inline Key BUTTON_SELECT = Key::J;
