...
struct Rect
{
    ...
    {
        return FloatingPoint<T>::almostEqual(other.x, x)
               && FloatingPoint<T>::almostEqual(other.y, y)
               && FloatingPoint<T>::almostEqual(other.w, w)
               && FloatingPoint<T>::almostEqual(other.h, h);
    }
