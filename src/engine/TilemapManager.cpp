...
void TilemapManager::createTilemap(RoomName mapName,
                                   ...
                                   const TileIndexArrays& mapEntries,
...
void TilemapManager::render()
{
    ...
    renderTileMap(Rect<int>{m_roomX, m_roomY, m_sprite->width(), m_sprite->height()},
                  *m_sprite,
                  m_currentRoom);

    // Render the swap canvas
    renderTileMap(Rect<int>{m_nextRoomX,
                            m_nextRoomY,
                            m_swapCanvas.width(),
                            m_swapCanvas.height()},
                  m_swapCanvas,
...
void TilemapManager::renderTileMap(const Rect<int>& dstRect,
                                   const Sprite& srcTexture,
...
TilemapManager::TilemapManager()
    ...
    , m_swapCanvas(Renderer::getInstance().getRenderer(),
                   m_sprite->width(),
                   m_sprite->height())
{
