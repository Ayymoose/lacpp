...
void Inventory::drawDungeonMap()
{
    ...
    */
    ...
    {
    case Dungeon::DUNGEON_COLOUR_DUNGEON:
        break;
    case Dungeon::DUNGEON_TAIL_CAVE:
        dstRect.x = 112;
        break;
    case Dungeon::DUNGEON_BOTTLE_GROTTO:
        break;
    case Dungeon::DUNGEON_KEY_CAVERN:
        break;
    case Dungeon::DUNGEON_ANGLER_TUNNEL:
        break;
    case Dungeon::DUNGEON_CATFISH_MAW:
        break;
    case Dungeon::DUNGEON_FACE_SHRINE:
        break;
    case Dungeon::DUNGEON_EAGLE_TOWER:
        break;
    case Dungeon::DUNGEON_TURTLE_ROCK:
        break;
    default:
        assert(false);
    }
            ...
            if (m_inventoryImpl.dungeonItem(DungeonItem::DUNGEON_ITEM_COMPASS))
            {
                if (m_inventoryImpl.dungeonMapLocationRoomItem(x, y) == DungeonMapItem::DUNGEON_MAP_ITEM_NIGHTMARE_KEY)
                {
                    ...
                    // dstRect = m_inventorySpritesDst[INVENTORY_AREA_NIGHTMARE];
                         ...
                         == DungeonMapItem::DUNGEON_MAP_ITEM_CHEST_CLOSED)
                {
...
void Inventory::drawDungeonItems()
{
    ...
    drawNumber(*m_sprite,
               ...
               true,
               0,
               m_inventoryImpl.dungeonItem(DungeonItem::DUNGEON_ITEM_LOCKED_DOOR_KEY),
               dstRect);
}
