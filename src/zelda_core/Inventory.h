...
public:
    ...
    std::array<Instrument, std::to_underlying(Instrument::INSTRUMENT_COUNT)> instruments() const;
    ...
    std::array<OcarinaSong, std::to_underlying(OcarinaSong::OCARINA_SONG_COUNT)> ocarinaSongs() const;
    ...
    std::array<Photograph, std::to_underlying(Photograph::PHOTOGRAPH_COUNT)> photographs() const;
...
private:
    ...
    std::array<OcarinaSong, std::to_underlying(OcarinaSong::OCARINA_SONG_COUNT)> m_ocarinaSongs;

    int m_secretSeaShells; // Number of Seashells

    std::array<InventoryMiscItem, std::to_underlying(InventoryMiscItem::INVENTORY_MISC_ITEM_COUNT)> m_inventoryMiscItems;
    ...
    std::array<Photograph, std::to_underlying(Photograph::PHOTOGRAPH_COUNT)> m_photographs;
    ...
    std::array<DungeonEntranceKey, std::to_underlying(DungeonEntranceKey::DUNGEON_ENTRACE_KEY_COUNT)>
        m_dungeonEntraceKeys;

    // Dungeon items
    std::array<DungeonItemStruct, std::to_underlying(Dungeon::DUNGEON_COUNT)> m_dungeonItemsStruct;
    ...
    */
    ...
    DungeonMapEntry m_dungeonMaps[std::to_underlying(Dungeon::DUNGEON_COUNT)][DUNGEON_MAX_BLOCKS_X]
                                 [DUNGEON_MAX_BLOCKS_Y] =
                                     {{// Lvl 0 - Colour dungeon
                                       {{1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        ...
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                       ...
                                       {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        ...
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {5, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {11, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {6, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {4, false, DungeonMapItem::DUNGEON_MAP_ITEM_NIGHTMARE_KEY},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {17, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {3, false, DungeonMapItem::DUNGEON_MAP_ITEM_CHEST_CLOSED},
                                        {8, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {19, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{19, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {5, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {17, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {10, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {10, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {10, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {15, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{13, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {14, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {11, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {15, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                       ...
                                       {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {5, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {20, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {18, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}}},
                                      {
                                          ...
                                          {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           ...
                                           {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {19, false, DungeonMapItem::DUNGEON_MAP_ITEM_NIGHTMARE_KEY},
                                           {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                          {{12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {17, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {11, false, DungeonMapItem::DUNGEON_MAP_ITEM_CHEST_CLOSED},
                                           {8, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {19, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                           {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                      ...
                                      {// Lvl 2 - Bottle Grotto
                                       ...
                                       {{0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        ...
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {4, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {1, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE}},
                                       {{12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {17, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {3, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {8, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {12, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {19, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
                                        {0, false, DungeonMapItem::DUNGEON_MAP_ITEM_NONE},
