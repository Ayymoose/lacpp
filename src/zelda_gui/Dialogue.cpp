...
void Dialogue::render()
{
    ...
    auto charSrcRect = [this](const char c)
    {
        ...
        return engine::Rect<int>{srcCharX, srcCharY, m_dialogueImpl.charWidth(), m_dialogueImpl.charHeight()};
    };

    // Start copying characters across
    engine::Rect<int> dstRectChar = {TEXT_POS_X + m_dstCharX * m_dialogueImpl.charWidth(),
...
Dialogue::Dialogue()
    ...
    , m_dstCharX(0)
    , m_dstCharY(0)
    , m_text(engine::ResourceManager::instance()[engine::SpriteResource::TEXT])
    ...
    , m_moreText(false)
    , m_toggleQuestion(15)
    , m_questionMarker(engine::ResourceManager::instance()[engine::SpriteResource::TEXT])
    , m_toggleArrow(30)
    , m_redArrow(engine::ResourceManager::instance()[engine::SpriteResource::TEXT])
    , m_continue(false)
    , m_scrollMessage(false)
    , m_scrolledLines(0)
    , m_questionXPos(0)
