...
namespace Tests
{
    ...
    void DialogueTests::dialogueSanityTests()
    {
...

        {
            ...
            {
                auto const& [q, c1, c2] = findQuestionChoices("Will you give me""28 Rupees for my""secret?         ""    Give Don't<ask>");
                assert(q == "Will you give me""28 Rupees for my""secret?" && c1 == "Give" && c2 == "Don't");
            }
        }
