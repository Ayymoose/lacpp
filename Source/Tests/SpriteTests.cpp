...
void SpriteTests::spriteTests() noexcept
{
    ...
    // Create sprite test
    auto spriteBall = Sprite(Renderer::getInstance().getRenderer(),
Resource::loadSprite(RESOURCE_OBJECT_PATH + "ball.png", TRANSPARENCY_COLOUR));
    auto spriteObstacle = Sprite(Renderer::getInstance().getRenderer(),
Resource::loadSprite(RESOURCE_OBJECT_PATH + "obstacle.png",
TRANSPARENCY_COLOUR));
        ...
        &colouredSprite]()
    {
        ...
        colouredSprite.colourSprite(Rect<int>{0, 0, 32, 32}, make_rgb(255, 0,
0)); colouredSprite.drawSprite(Rect<int>{0, 0, 32, 32}, dstRect7);
    };
