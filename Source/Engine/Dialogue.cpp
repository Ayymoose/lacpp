...
namespace Zelda
{
    ...
    bool Dialogue::question(const std::string& question, const std::string& choice1, const std::string& choice2, float yPos)
    {
        // Displays a message on screen to the player
        // Engine is paused while the message is being displayed
        Engine::getInstance().pause(true);
    ...
    void Dialogue::checkCharacters(const std::string& string) const
    {
