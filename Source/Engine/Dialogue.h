...
namespace Zelda
{
    ...
    public:
        ...
        bool question(const std::string& question, const std::string& choice1, const std::string& choice2, float yPos);
    ...
    private:
        ...
        void reset();
        void checkCharacters(const std::string& string) const;
